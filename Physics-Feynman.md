...
Proper time (\(\tau \)) is the time interval between two events measured by a single clock present at both events, 
representing the actual time experienced along a specific trajectory. It is an invariant quantity in relativity, 
meaning all observers agree on the elapsed proper time, **unlike coordinate time**. 
...
# Leonard Susskind The Universe According to Susskind

[Why Death Is Not a Physical Event | Leonard Susskind The Universe According to Susskind](https://www.youtube.com/watch?v=lqjiS8RqA7Y)  

---

[The Biggest Ideas in the Universe! by Sean Carroll](https://www.youtube.com/playlist?list=PLrxfgDEc2NxZJcWcrxH3jyjUUrJlnoyzX)
